...
function Page2() {
  ...
  return (
    <div id="sandbox-1" className="w-[100vw] relative md:w-full">
      <h2 className="font-[ANZO3] pt-6 md:block hidden pb-24 text-center text-[1.35vw] text-[#8a8a8a]">
        © anzo.studio 2024 | designed and developed
      </h2>
      
      <div className="block py-4 pb-20 md:hidden">
      <div className="flex justify-center relative">
        ...
        <div className="w-[86%] absolute border-black border-b-[1px] -bottom-4"></div>
      </div>
      </div>

      <div>
        <h1 className="text-center rotate-text   font-[ANZO5] uppercase leading-[33.3vw] text-[41vw]">
          IMPACTFUL
        </h1>
      </div>
      <div>
      ...
      <div className="flex justify-center pb-10 relative">
        ...
        <div className="w-[27%] absolute border-black border-b-[2px]  bottom-0"></div>
      </div>
      </div>
    </div>
  );
